...
Scenario Outline: To probe route code response  /persona
  ...
  |GET   |/v1/persona|./files/req/Vacio.json|200 OK       |
...
Scenario Outline: To probe response route /persona       
  ...
  |GET   |/v1/persona|./files/req/Vacio.json|200 OK         |./files/res11/Vok1.json |
  |POST  |/v1/persona|./files/req/Vacio.json|400 Bad Request|./files/res11/Ierr1.json|
