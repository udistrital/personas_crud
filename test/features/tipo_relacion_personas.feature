...
Scenario Outline: To probe response route /tipo_relacion_personas       
    ...
    |POST   |/v1/tipo_relacion_personas  |./files/req/Nt3.json   |200 OK     |./files/res9/Ierr3.json         |
    |POST   |/v1/tipo_relacion_personas  |./files/req/Nt4.json   |200 OK     |./files/res9/Ierr4.json         |
    |POST   |/v1/tipo_relacion_personas  |./files/req/Nt5.json   |200 OK     |./files/res9/Ierr5.json         | 
    |PUT    |/v1/tipo_relacion_personas  |./files/req/Yt2.json   |200 OK     |./files/res9/Vok1.json          |
    |GETID  |/v1/tipo_relacion_personas  |./files/req/Vacio.json |200 OK     |./files/res9/Vok1.json          |
    |DELETE |/v1/tipo_relacion_personas  |./files/req/Vacio.json |200 OK     |./files/res9/Vok1.json          |
    |DELETE |/v1/tipo_relacion_personas  |./files/req/Vacio.json |200 OK     |./files/res9/Ino.json           |
