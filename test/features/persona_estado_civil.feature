...
Scenario Outline: To probe response route /persona_estado_civil       
  ...
  |GET   |/v1/persona_estado_civil|./files/req/Vacio.json|200 OK         |./files/res6/Vok1.json |
  |POST  |/v1/persona_estado_civil|./files/req/Vacio.json|400 Bad Request|./files/res6/Ierr1.json|
